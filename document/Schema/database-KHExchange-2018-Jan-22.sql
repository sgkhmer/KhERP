...
CREATE TABLE `sg_menu` (
  ...
  `menu_type_id` int(11) NOT NULL DEFAULT '1',
...
insert  into `sg_menu`(`menu_id`,`menu_type_id`,`icon`,`menu_name`,`menu_code`,`order_level`,`url`,`default`,`parent_id`) values (1,1,'fa-user','User Management','m01',4,'/admin/user_mgr',0,0),(7,1,'fa-dashboard','Dashboard','m05',1,'/admin/dashboard',0,0),(8,1,NULL,'Users','s01',1,'/admin/user_mgr/user',0,1),(9,1,NULL,'Users Group','s02',2,'/admin/user_mgr/group_user',0,1),(10,1,NULL,'Group Roles','s03',3,'/admin/user_mgr/group_role',0,1),(33,1,NULL,'Dashboard','s04',4,'/admin/dashboard',0,7),(37,1,'fa-gears','Setting','m03',8,'/admin/setting',0,0),(38,1,'fa-cog','Exchange','s08',2,'/admin/dashboard/#/exchange_money/exchange',0,37),(39,1,NULL,'Config Group','s07',1,'/admin/dashboard/#/exchange_money/exchange',0,37),(40,1,'fa-users','Assign Management','m02',3,'/admin/dashboard/#/exchange_money/exchange',0,0),(44,1,NULL,'Language','s06',6,'/admin/dashboard/#/exchange_money/exchange',0,37),(46,1,NULL,'Landing','s09',9,'/admin/dashboard/#/exchange_money/exchange',0,63),(63,1,'fa fa-image','Design','m06',5,'/admin/dashboard/#/exchange_money/exchange',0,0),(76,1,NULL,'Assign Services','s18',1,'/admin/assign/services',0,40),(80,1,NULL,'Assign Contents','s22',4,'/admin/assign/contents',0,40),(83,1,'fa fa-info-circle','Setup Master','m09',2,'/admin/setup',0,0),(84,1,NULL,'Content Type','s25',1,'/admin/setup/content_types',0,83),(86,1,NULL,'Partners','s27',4,'/admin/design/partner',0,1),(98,1,NULL,'Pricing Plan','s57',2,'/admin/setup/pricing_plans',0,83),(99,1,NULL,'Frequency','s58',3,'/admin/setup/frequencies',0,83),(100,1,NULL,'Assign Partners','s59',3,'/admin/assign/partners',0,40),(101,1,NULL,'AOC Page','s60',3,'/admin/design/aoc_design',0,63),(102,1,NULL,'Short Codes','s61',5,'/admin/setup/short_codes',0,83),(103,1,'fa fa-clipboard','Reports','m10',7,'/admin/report',0,0),(105,1,NULL,'Masterlist Report','s63',2,'/admin/report/master',0,103),(106,1,NULL,'ServiceID','s64',4,'/admin/setup/services',0,83),(107,1,NULL,'Assign Pages URL','s65',2,'/admin/assign/page_url',0,40),(108,1,NULL,'ServiceID Reports','s66',2,'/admin/report/serviceID',0,103),(109,1,NULL,'Active URL Reports','s67',3,'/admin/report/active_url',0,103),(110,1,NULL,'Authority','s68',3,'/admin/setting/authority',0,37);
...
insert  into `sg_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','$2y$10$flAZmP7ClUp0gG54aYNzNutHgSlMSLyACRg.NVtRpqDfjLouJICIy','0Y3pe4Cx4','John','Doe','sreyleakyem@hotmail.com','','','127.0.0.1',1,'2017-11-20 14:03:44');
