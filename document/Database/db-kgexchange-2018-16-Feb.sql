...
/*Table structure for table `sg_account` */
...
/*Data for the table `sg_account` */

/*Table structure for table `sg_account_bank` */

DROP TABLE IF EXISTS `sg_account_bank`;

CREATE TABLE `sg_account_bank` (
...
/*Data for the table `sg_account_bank` */

/*Table structure for table `sg_account_deposit` */

DROP TABLE IF EXISTS `sg_account_deposit`;

CREATE TABLE `sg_account_deposit` (
...
/*Data for the table `sg_account_deposit` */

/*Table structure for table `sg_account_exchange_currency` */

DROP TABLE IF EXISTS `sg_account_exchange_currency`;

CREATE TABLE `sg_account_exchange_currency` (
  `account_id` int(11) DEFAULT NULL,
...
/*Data for the table `sg_account_exchange_currency` */

/*Table structure for table `sg_account_loan` */

DROP TABLE IF EXISTS `sg_account_loan`;

CREATE TABLE `sg_account_loan` (
...
/*Data for the table `sg_account_loan` */

/*Table structure for table `sg_account_master` */

DROP TABLE IF EXISTS `sg_account_master`;

CREATE TABLE `sg_account_master` (
...
/*Data for the table `sg_account_master` */

/*Table structure for table `sg_account_mobile_log` */

DROP TABLE IF EXISTS `sg_account_mobile_log`;

CREATE TABLE `sg_account_mobile_log` (
...
/*Data for the table `sg_account_mobile_log` */

/*Table structure for table `sg_account_payee` */

DROP TABLE IF EXISTS `sg_account_payee`;

CREATE TABLE `sg_account_payee` (
...
/*Data for the table `sg_account_payee` */

/*Table structure for table `sg_account_rule` */

DROP TABLE IF EXISTS `sg_account_rule`;

CREATE TABLE `sg_account_rule` (
  `account_rule_id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`account_rule_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_account_rule` */

insert  into `sg_account_rule`(`account_rule_id`,`name`) values (1,'Cash Based'),(2,'Accrual Periodic'),(3,'Accrual Upfront');

/*Table structure for table `sg_account_send_money` */

DROP TABLE IF EXISTS `sg_account_send_money`;

CREATE TABLE `sg_account_send_money` (
  `account_id` int(11) DEFAULT NULL,
...
/*Data for the table `sg_account_send_money` */

/*Table structure for table `sg_account_transaction` */

DROP TABLE IF EXISTS `sg_account_transaction`;

CREATE TABLE `sg_account_transaction` (
...
/*Data for the table `sg_account_transaction` */

/*Table structure for table `sg_account_transfer` */

DROP TABLE IF EXISTS `sg_account_transfer`;

CREATE TABLE `sg_account_transfer` (
...
/*Data for the table `sg_account_transfer` */

/*Table structure for table `sg_account_type` */

DROP TABLE IF EXISTS `sg_account_type`;

CREATE TABLE `sg_account_type` (
  `account_type_id` int(2) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`account_type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_account_type` */

insert  into `sg_account_type`(`account_type_id`,`name`) values (1,'Coporate'),(2,'Individual');

/*Table structure for table `sg_account_withdraw` */

DROP TABLE IF EXISTS `sg_account_withdraw`;

CREATE TABLE `sg_account_withdraw` (
  `account_id` int(11) NOT NULL,
...
/*Data for the table `sg_account_withdraw` */
...
/*Table structure for table `sg_amount_top_up` */

DROP TABLE IF EXISTS `sg_amount_top_up`;

CREATE TABLE `sg_amount_top_up` (
  `amount_top_up_id` int(2) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`amount_top_up_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_amount_top_up` */

insert  into `sg_amount_top_up`(`amount_top_up_id`,`name`) values (1,'1'),(2,'2'),(3,'5'),(4,'10'),(5,'15'),(6,'20'),(7,'50'),(8,'100');
...
/*Table structure for table `sg_booking` */

DROP TABLE IF EXISTS `sg_booking`;

CREATE TABLE `sg_booking` (
...
/*Data for the table `sg_booking` */

insert  into `sg_booking`(`booking_id`,`account_no`,`booking_type`,`origin`,`destincation`,`sector`,`booking_date`,`fly_date`,`fly_time`,`return_date`,`return_time`,`status`) values (1,'001','One Way','PHN','SR','PHN-SR','2015-02-11 00:00:00','2015-02-11','12:00:00','2016-02-11','12:22:00',1);

/*Table structure for table `sg_booking_type` */

DROP TABLE IF EXISTS `sg_booking_type`;

CREATE TABLE `sg_booking_type` (
  `booking_type` int(2) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`booking_type`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_booking_type` */

insert  into `sg_booking_type`(`booking_type`,`name`) values (1,'One Way'),(2,'Round Trip');

/*Table structure for table `sg_buy_voucher` */

DROP TABLE IF EXISTS `sg_buy_voucher`;

CREATE TABLE `sg_buy_voucher` (
...
/*Data for the table `sg_buy_voucher` */
...
DROP TABLE IF EXISTS `sg_contact`;

CREATE TABLE `sg_contact` (
  `contact_id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `position` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `telephone` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `date_added` datetime NOT NULL,
  PRIMARY KEY (`contact_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_contact` */
...
insert  into `sg_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.61250001,1,'2014-09-25 14:40:00'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2017-11-20 07:31:04');
...
/*Table structure for table `sg_customer_balance` */

DROP TABLE IF EXISTS `sg_customer_balance`;

CREATE TABLE `sg_customer_balance` (
...
/*Data for the table `sg_customer_balance` */

/*Table structure for table `sg_customer_credit_setting` */

DROP TABLE IF EXISTS `sg_customer_credit_setting`;

CREATE TABLE `sg_customer_credit_setting` (
  ...
  PRIMARY KEY (`reseller_credit_setting_id`,`customer_id`,`credit_type_id`,`credit_type_value_id`),
  UNIQUE KEY `reseller_credit_setting_id` (`reseller_credit_setting_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_customer_credit_setting` */
...
/*Table structure for table `sg_customer_type` */

DROP TABLE IF EXISTS `sg_customer_type`;

CREATE TABLE `sg_customer_type` (
  `customer_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`customer_type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_customer_type` */

insert  into `sg_customer_type`(`customer_type_id`,`name`) values (1,'Lead'),(2,'Apportunity'),(3,'Customer');

/*Table structure for table `sg_delivery_method` */

DROP TABLE IF EXISTS `sg_delivery_method`;

CREATE TABLE `sg_delivery_method` (
...
/*Data for the table `sg_delivery_method` */

insert  into `sg_delivery_method`(`delivery_method_id`,`name`,`created_by`,`modified_by`,`created_at`,`updated_at`) values (1,'Airtime Topup',NULL,NULL,NULL,NULL),(2,'Bank Transfer',NULL,NULL,NULL,NULL),(3,'Bill Payment',NULL,NULL,NULL,NULL),(4,'Cash Picker',NULL,NULL,NULL,NULL),(5,'Mobile Transfer',NULL,NULL,NULL,NULL),(6,'Wallet',NULL,NULL,NULL,NULL);
...
/*Table structure for table `sg_exchange_rate` */

DROP TABLE IF EXISTS `sg_exchange_rate`;

CREATE TABLE `sg_exchange_rate` (
...
/*Data for the table `sg_exchange_rate` */

/*Table structure for table `sg_exchange_rate_history` */

DROP TABLE IF EXISTS `sg_exchange_rate_history`;

CREATE TABLE `sg_exchange_rate_history` (
  `exchange_rate_id` int(11) NOT NULL AUTO_INCREMENT,
  `from_currency_id` int(11) NOT NULL DEFAULT '1',
  `to_currency_id` int(11) NOT NULL DEFAULT '1',
  `rate` double NOT NULL,
...
/*Data for the table `sg_exchange_rate_history` */
...
/*Table structure for table `sg_interest_method_id` */

DROP TABLE IF EXISTS `sg_interest_method_id`;

CREATE TABLE `sg_interest_method_id` (
...
/*Data for the table `sg_interest_method_id` */

/*Table structure for table `sg_interest_rate_period` */

DROP TABLE IF EXISTS `sg_interest_rate_period`;

CREATE TABLE `sg_interest_rate_period` (
  `interest_rate_period_id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`interest_rate_period_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_interest_rate_period` */

insert  into `sg_interest_rate_period`(`interest_rate_period_id`,`name`) values (1,'Perday'),(2,'Perweek'),(3,'Permonth'),(4,'Peryear');
...
/*Table structure for table `sg_loan_product` */

DROP TABLE IF EXISTS `sg_loan_product`;

CREATE TABLE `sg_loan_product` (
...
/*Data for the table `sg_loan_product` */

insert  into `sg_loan_product`(`loan_product_id`,`name`,`principle_default_amount`,`principle_min_amount`,`principle_max_amount`,`term_period`,`term_day_id`,`payment_cycle_id`,`interest_rate_period_id`,`interest_method_id`,`account_rule_id`) values (1,'Cash Loan',3000.0000,1000.0000,3000.0000,2,1,NULL,NULL,NULL,NULL);
...
DROP TABLE IF EXISTS `sg_menu_type`;

CREATE TABLE `sg_menu_type` (
  `menu_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`menu_type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `sg_menu_type` */

insert  into `sg_menu_type`(`menu_type_id`,`name`) values (1,'Main Menu');
...
/*Table structure for table `sg_payment_cycle` */

DROP TABLE IF EXISTS `sg_payment_cycle`;

CREATE TABLE `sg_payment_cycle` (
  `payment_cycle_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`payment_cycle_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_payment_cycle` */

insert  into `sg_payment_cycle`(`payment_cycle_id`,`name`) values (1,'Dialy'),(2,'Weekly'),(3,'Monthly'),(4,'Semi-Anuual'),(5,'Annually');
...
CREATE TABLE `sg_payment_method` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `method_name` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  `alias` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
/*Table structure for table `sg_restrict_type` */

DROP TABLE IF EXISTS `sg_restrict_type`;

CREATE TABLE `sg_restrict_type` (
  `restrict_type_id` int(2) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`restrict_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_restrict_type` */

/*Table structure for table `sg_rule_type` */

DROP TABLE IF EXISTS `sg_rule_type`;

CREATE TABLE `sg_rule_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rule_type` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_rule_type` */
...
/*Table structure for table `sg_status` */

DROP TABLE IF EXISTS `sg_status`;

CREATE TABLE `sg_status` (
...
/*Data for the table `sg_status` */

insert  into `sg_status`(`status_id`,`group`,`name`) values (1,'Account','Credit'),(2,'Account','Debit'),(3,'Account','Advance Pay');

/*Table structure for table `sg_stock_currency` */

DROP TABLE IF EXISTS `sg_stock_currency`;

CREATE TABLE `sg_stock_currency` (
  `stock_currency_id` int(3) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`stock_currency_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_stock_currency` */
...
/*Table structure for table `sg_term_day` */

DROP TABLE IF EXISTS `sg_term_day`;

CREATE TABLE `sg_term_day` (
  `term_day_id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`term_day_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `sg_term_day` */

insert  into `sg_term_day`(`term_day_id`,`name`) values (1,'Day(s)'),(2,'Week(s)'),(3,'Month(s)'),(4,'Year(s)');
...
/*Table structure for table `sg_transaction_rules` */

DROP TABLE IF EXISTS `sg_transaction_rules`;

CREATE TABLE `sg_transaction_rules` (
...
/*Data for the table `sg_transaction_rules` */
...
insert  into `sg_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values (1,1,'adminss','$2y$10$flAZmP7ClUp0gG54aYNzNutHgSlMSLyAC','0Y3pe4Cx4','John','Doe','sreyleakyem@hotmail.com','','','127.0.0.1',1,'2017-11-20 14:03:44');
