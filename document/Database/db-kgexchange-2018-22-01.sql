...
CREATE TABLE `sg_account_transaction` (
  ...
  CONSTRAINT `FK_sg_account_transaction_rule` FOREIGN KEY (`transaction_rule_id`) REFERENCES `sg_transaction_rules` (`account_transaction_rule_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `sg_account_transfer` (
  ...
  `transfer_no` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  `transfer_from_account_id` int(4) DEFAULT NULL,
  `transfer_to_account_id` int(4) DEFAULT NULL,
  ...
  KEY `FK_sg_account_transfer` (`transfer_from_account_id`),
  KEY `FK_sg_account_transfers` (`delivery_method_id`),
  KEY `FK_sg_account_transfer_to_account` (`transfer_to_account_id`),
  ...
  CONSTRAINT `FK_sg_account_transfer` FOREIGN KEY (`transfer_from_account_id`) REFERENCES `sg_account` (`account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_sg_account_transfers` FOREIGN KEY (`delivery_method_id`) REFERENCES `sg_delivery_method` (`delivery_method_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `FK_sg_account_transfer_to_account` FOREIGN KEY (`transfer_to_account_id`) REFERENCES `sg_account` (`account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
insert  into `sg_attribute_description`(`attribute_id`,`language_id`,`name`) values (1,1,'Description'),(2,1,'No. of Cores'),(3,1,'Clockspeed'),(4,1,'test 1'),(5,1,'test 2'),(6,1,'test 3'),(7,1,'test 4'),(8,1,'test 5'),(9,1,'test 6'),(10,1,'test 7'),(11,1,'test 8');
...
insert  into `sg_banner_image`(`banner_image_id`,`banner_id`,`language_id`,`title`,`link`,`image`,`sort_order`) values (79,7,1,'iPhone 6','index.php?route=product/product&amp;path=57&amp;product_id=49','catalog/demo/banners/iPhone6.jpg',0),(80,7,1,'MacBookAir','','catalog/demo/banners/MacBookAir.jpg',0),(87,6,1,'HP Banner','index.php?route=product/manufacturer/info&amp;manufacturer_id=7','catalog/demo/compaq_presario.jpg',0),(88,8,1,'Harley Davidson','','catalog/demo/manufacturer/harley.png',0),(89,8,1,'Dell','','catalog/demo/manufacturer/dell.png',0),(90,8,1,'Disney','','catalog/demo/manufacturer/disney.png',0),(91,8,1,'Coca Cola','','catalog/demo/manufacturer/cocacola.png',0),(92,8,1,'Burger King','','catalog/demo/manufacturer/burgerking.png',0),(93,8,1,'Canon','','catalog/demo/manufacturer/canon.png',0),(94,8,1,'NFL','','catalog/demo/manufacturer/nfl.png',0),(95,8,1,'RedBull','','catalog/demo/manufacturer/redbull.png',0),(96,8,1,'Sony','','catalog/demo/manufacturer/sony.png',0),(97,8,1,'Starbucks','','catalog/demo/manufacturer/starbucks.png',0),(98,8,1,'Nintendo','','catalog/demo/manufacturer/nintendo.png',0);
...
insert  into `sg_category_to_layout`(`category_id`,`store_id`,`layout_id`) values (28,0,0),(28,1,0),(33,0,0),(33,1,0);
...
insert  into `sg_credit_type`(`credit_type_id`,`language_id`,`name`) values (1,1,'Advance Payment'),(2,1,'Credit');
...
insert  into `sg_credit_type_value`(`credit_type_value_id`,`credit_type_id`,`name`,`value`) values (1,2,'1 Week','7:day'),(2,2,'2 Weeks','14:day'),(3,3,'3 Weeks','21:day');
...
...
insert  into `sg_menu`(`id`,`fa_icon`,`parent_id`,`menu_type_id`,`menu_link`,`menu_code`,`default`,`url`,`ordering`,`is_active`,`created_date`,`modified_date`) values (1,'home',0,1,'/admin','y5_m01',1,'/',1,1,NULL,NULL),(2,'dvr',0,1,'/admin/admin','y5_m02',0,'/admin/admin',2,0,NULL,NULL),(4,'person',0,1,'/admin/users','y5_m10',0,NULL,4,1,NULL,NULL),(5,'settings',0,1,'/admin/config/configuration','y5_m11',0,NULL,5,1,NULL,NULL),(6,'dvr',4,1,'/admin/users/list','y5_s24',0,'/admin/users',45,1,NULL,NULL),(7,'dvr',4,1,'/admin/users_group/list','y5_s25',0,'admin/user_group',45,1,NULL,NULL),(8,'dvr',4,1,'/admin/user_role/list','y5_s26',0,'/admin/users_group_role',45,1,NULL,NULL),(9,'dvr',5,1,'/admin/config/config_group','y5_s27',0,NULL,45,1,NULL,NULL),(10,'dvr',5,1,'/admin/config/configuration','y5_s43',0,NULL,45,1,NULL,NULL),(11,'dvr',0,1,'/admin/dashboard','y5_m14',0,NULL,6,1,NULL,NULL),(12,'shuffle',0,1,'/setup/system','y5_m15',0,NULL,16,1,NULL,NULL),(13,'dvr',12,1,'/admin/setup_mgr/currency','y5_s28',0,NULL,45,1,NULL,NULL),(15,'shopping_cart',0,1,'/setup/sale','y5_m16',0,NULL,15,1,NULL,NULL),(16,'dvr',15,1,'/setup/sale/agency','y5_s30',0,NULL,45,1,NULL,NULL),(17,'dvr',44,1,'/admin/customer_mgr/customer','y5_s31',0,NULL,45,1,NULL,NULL),(19,'dvr',15,1,'/setup/sale/invoice','y5_s33',0,NULL,45,1,NULL,NULL),(21,'assignment',0,1,'/setup/sale/stock','y5_m17',0,NULL,14,1,NULL,NULL),(23,'dvr',12,1,'/admin/setup_mgr/item_category','y5_s36',0,NULL,45,1,NULL,NULL),(24,'dvr',37,1,'/admin/setup_mgr/item','y5_s37',0,NULL,1,1,NULL,NULL),(25,'dvr',21,1,'/admin/stock_mgr/actual_stock','y5_s38',0,NULL,45,1,NULL,NULL),(27,'dvr',21,1,'/setup/sale/stock/bank_account_history','y5_s40',0,NULL,45,0,NULL,NULL),(29,'dvr',5,1,'/admin/config/next_code','y5_s42',0,NULL,45,1,NULL,NULL),(30,'dvr',12,1,'/admin/setup_mgr/department','y5_s44',0,NULL,45,1,NULL,NULL),(31,'dvr',12,1,'/admin/setup_mgr/position','y5_s45',0,NULL,45,1,NULL,NULL),(32,'dvr',12,1,'/admin/setup_mgr/branch_group','y5_s46',0,NULL,45,1,NULL,NULL),(33,'dvr',12,1,'/admin/setup_mgr/branch','y5_s47',0,NULL,45,1,NULL,NULL),(34,'dvr',12,1,'/admin/setup_mgr/unit_group','y5_s48',0,NULL,45,1,NULL,NULL),(35,'dvr',12,1
,1,'/admin/quotation','y5_m24',0,NULL,8,1,NULL,NULL),(77,'dvr',76,1,'/admin/quotation/create','y5_s84',0,NULL,45,1,NULL,NULL),(78,'dvr',76,1,'/admin/quotation','y5_s85',0,NULL,45,1,NULL,NULL),(79,'send',0,1,'/admin/transfer','y5_m25',0,NULL,7,1,NULL,NULL),(80,'dvr',79,1,'/admin/transfer','y5_s86',0,NULL,45,1,NULL,NULL),(83,'dvr',37,1,'/admin/item_mgr/item_in_stock','y5_s89',0,NULL,3,1,NULL,NULL),(87,'dvr',15,1,'/admin/sale_mgr/sale_order','y5_s93',0,NULL,2,1,NULL,NULL),(88,'dvr',12,1,'/admin/setup_mgr/item_sub_category','y5_s94',0,NULL,0,1,NULL,NULL),(89,'dvr',37,1,'/admin/item_mgr/item_barcode','y5_s95',0,NULL,4,1,NULL,NULL),(90,'loyalty',0,1,'/admin/discount','y5_m26',0,NULL,5,1,NULL,NULL),(91,'dvr',90,1,'/admin/discount/discount_item','y5_s96',0,NULL,2,1,NULL,NULL),(92,'dvr',90,1,'/admin/discount/discount_methods','y5_s97',0,NULL,1,1,NULL,NULL),(93,'dvr',90,1,'/admin/discount/discount_permission','y5_s98',0,NULL,0,1,NULL,NULL),(94,'person',0,1,'/admin/vendor','sg_m30',0,NULL,18,1,NULL,NULL),(96,'dvr',94,1,'/admin/vendor/list','sg_s99',0,NULL,0,1,NULL,NULL);
...
insert  into `sg_menu_description`(`id`,`menu_id`,`language_id`,`name`,`meta_description`,`meta_keywords`) values (1,1,2,'Home',NULL,NULL),(2,2,2,'Administrator',NULL,NULL),(4,4,2,'Users',NULL,NULL),(5,5,2,'Setting',NULL,NULL),(7,7,2,'User groups',NULL,NULL),(8,8,2,'Group roles',NULL,NULL),(9,9,2,'Config groups',NULL,NULL),(10,10,2,'Configuration',NULL,NULL),(77,6,2,'Users',NULL,NULL),(78,12,2,'Catalog',NULL,NULL),(79,13,2,'Currency Rates',NULL,NULL),(81,15,2,'Sales',NULL,NULL),(82,16,2,'Agency',NULL,NULL),(83,17,2,'Customers',NULL,NULL),(84,18,2,'Quotation',NULL,NULL),(85,19,2,'Actual Invoice',NULL,NULL),(87,21,2,'Logistic',NULL,NULL),(89,23,2,'Options',NULL,NULL),(90,24,2,'Item List',NULL,NULL),(91,25,2,'Logistic List',NULL,NULL),(94,29,2,'Next Codes',NULL,NULL),(95,30,2,'Attributes',NULL,NULL),(96,31,2,'Positions',NULL,NULL),(97,32,2,'Categories',NULL,NULL),(98,33,2,'Products',NULL,NULL),(99,34,2,'Information',NULL,NULL),(100,35,2,'Units',NULL,NULL),(101,36,2,'Attribute Groups',NULL,NULL),(102,37,2,'Accounts',NULL,NULL),(103,38,2,'Reviews',NULL,NULL),(104,39,2,'Outstanding Invoice',NULL,NULL),(105,40,2,'Item Base Vendor',NULL,NULL),(106,41,2,'Suppliers',NULL,NULL),(107,42,2,'Suppliers',NULL,NULL),(109,44,2,'Customers',NULL,NULL),(111,46,2,'Customer Groups',NULL,NULL),(112,47,2,'Customer Fields',NULL,NULL),(113,48,2,'Tools',NULL,NULL),(114,49,2,'Back Up / Restore',NULL,NULL),(115,50,2,'Language',NULL,NULL),(120,55,2,'Purchase Invoice',NULL,NULL),(121,56,2,'Purchase Order',NULL,NULL),(122,57,2,'Purchase Order Number',NULL,NULL),(123,58,2,'Purchase Order Vendor',NULL,NULL),(125,60,2,'Returning',NULL,NULL),(126,62,2,'Reports',NULL,NULL),(127,63,2,'Revenue Reports',NULL,NULL),(128,64,2,'Inventory On Hand',NULL,NULL),(129,65,2,'Purchase Item',NULL,NULL),(130,66,2,'Item Information',NULL,NULL),(131,67,2,'Item Transfer',NULL,NULL),(132,68,2,'Add Logistic',NULL,NULL),(133,61,2,'Manufacturers',NULL,NULL),(138,74,2,'Filters',NULL,NULL),(139,75,2,'Item Type',NULL,NULL),(140,76,2,'Quotation',NULL,NULL),(141,77,2,'Quotation From',NULL,NULL),(142,78,2,'Quotation List',NULL,NULL),(143,79,2,'Transfers',NULL,NULL),(144,80,2,'Transfer',NULL,NULL),(146,82,2,'Transfer List',NULL,NULL),(147,83,2,'Items In Stock',NULL,NULL),(151,87,2,'Sale Orders',NULL,NULL),(152,88,2,'Download',NULL,NULL),(153,70,2,'Stock Type',NULL,NULL),(154,89,2,'Options',NULL,NULL),(155,90,2,'Discount',NULL,NULL),(156,91,2,'Discount By Items',NULL,NULL),(157,92,2,'Discount Methods',NULL,NULL),(158,93,2,'Discount Permission',NULL,NULL),(159,96,2,'Reseller List',NULL,NULL),(160,94,2,'Resellers',NULL,NULL);
...
insert  into `sg_module`(`module_id`,`name`,`code`,`setting`) values (27,'Home Page','slideshow','{\"name\":\"Home Page\",\"banner_id\":\"7\",\"width\":\"1140\",\"height\":\"380\",\"status\":\"1\"}'),(28,'Home Page','featured','{\"name\":\"Home Page\",\"product\":[\"43\",\"40\",\"42\",\"30\"],\"limit\":\"4\",\"width\":\"200\",\"height\":\"200\",\"status\":\"1\"}'),(29,'Home Page','carousel','{\"name\":\"Home Page\",\"banner_id\":\"8\",\"width\":\"130\",\"height\":\"100\",\"status\":\"1\"}'),(30,'Category','banner','{\"name\":\"Category\",\"banner_id\":\"6\",\"width\":\"182\",\"height\":\"182\",\"status\":\"1\"}'),(31,'Banner 1','banner','{\"name\":\"Banner 1\",\"banner_id\":\"6\",\"width\":\"182\",\"height\":\"182\",\"status\":\"1\"}');
...
insert  into `sg_option_description`(`option_id`,`language_id`,`name`) values (1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(5,1,'Select'),(6,1,'Textarea'),(7,1,'File'),(8,1,'Date'),(9,1,'Time'),(10,1,'Date &amp; Time'),(11,1,'Size'),(12,1,'Delivery Date');
...
insert  into `sg_option_value`(`option_value_id`,`option_id`,`image`,`sort_order`) values (23,2,'',1),(24,2,'',2),(31,1,'',2),(32,1,'',1),(39,5,'',1),(40,5,'',2),(41,5,'',3),(42,5,'',4),(43,1,'',3),(44,2,'',3),(45,2,'',4),(46,11,'',1),(47,11,'',2),(48,11,'',3);
...
insert  into `sg_option_value_description`(`option_value_id`,`language_id`,`option_id`,`name`) values (23,1,2,'Checkbox 1'),(24,1,2,'Checkbox 2'),(31,1,1,'Medium'),(32,1,1,'Small'),(39,1,5,'Red'),(40,1,5,'Blue'),(41,1,5,'Green'),(42,1,5,'Yellow'),(43,1,1,'Large'),(44,1,2,'Checkbox 3'),(45,1,2,'Checkbox 4'),(46,1,11,'Small'),(47,1,11,'Medium'),(48,1,11,'Large');
...
insert  into `sg_order_status`(`order_status_id`,`language_id`,`name`) values (1,1,'Pending'),(2,1,'Processing'),(3,1,'Shipped'),(5,1,'Complete'),(7,1,'Canceled'),(8,1,'Denied'),(9,1,'Canceled Reversal'),(10,1,'Failed'),(11,1,'Refunded'),(12,1,'Reversed'),(13,1,'Chargeback'),(14,1,'Expired'),(15,1,'Processed'),(16,1,'Voided');
...
insert  into `sg_product_attribute`(`product_id`,`attribute_id`,`language_id`,`text`) values (42,3,1,'100mhz'),(43,2,1,'1'),(43,4,1,'8gb'),(47,2,1,'4'),(47,4,1,'16GB');
...
insert  into `sg_product_option`(`product_option_id`,`product_id`,`option_id`,`value`,`required`) values (208,42,4,'test',1),(209,42,6,'',1),(217,42,5,'',1),(218,42,1,'',1),(219,42,8,'2011-02-20',1),(220,42,10,'2011-02-20 22:25',1),(221,42,9,'22:25',1),(222,42,7,'',1),(223,42,2,'',1),(224,35,11,'',1),(225,47,12,'2011-04-22',1),(226,30,5,'',1);
...
insert  into `sg_product_special`(`product_special_id`,`product_id`,`customer_group_id`,`priority`,`price`,`date_start`,`date_end`) values (438,30,1,1,'80.0000','0000-00-00','0000-00-00'),(439,30,1,2,'90.0000','0000-00-00','0000-00-00'),(441,42,1,1,'90.0000','0000-00-00','0000-00-00');
...
insert  into `sg_product_to_category`(`product_id`,`category_id`) values (43,18),(44,18),(45,18),(46,18),(47,18),(28,20),(29,20),(30,20),(33,20),(35,20),(40,20),(42,20),(43,20),(44,20),(46,20),(47,20),(48,20),(28,24),(29,24),(40,24),(41,27),(33,28),(42,28),(30,33),(31,33),(32,34),(34,34),(36,34),(48,34),(49,57);
...
insert  into `sg_product_to_layout`(`product_id`,`store_id`,`layout_id`) values (42,0,0),(42,1,0);
...
insert  into `sg_seo_url`(`seo_url_id`,`store_id`,`language_id`,`query`,`keyword`) values (730,0,1,'manufacturer_id=8','apple'),(772,0,1,'information_id=4','about_us'),(774,0,1,'category_id=18','laptop-notebook'),(775,0,1,'category_id=46','macs'),(776,0,1,'category_id=45','windows'),(777,0,1,'category_id=25','component'),(778,0,1,'category_id=29','mouse'),(780,0,1,'category_id=35','test1'),(781,0,1,'category_id=36','test2'),(782,0,1,'category_id=30','printer'),(783,0,1,'category_id=31','scanner'),(784,0,1,'category_id=32','web-camera'),(785,0,1,'category_id=57','tablet'),(786,0,1,'category_id=17','software'),(787,0,1,'category_id=24','smartphone'),(789,0,1,'category_id=34','mp3-players'),(790,0,1,'category_id=43','test11'),(791,0,1,'category_id=44','test12'),(792,0,1,'category_id=47','test15'),(793,0,1,'category_id=48','test16'),(794,0,1,'category_id=49','test17'),(795,0,1,'category_id=50','test18'),(796,0,1,'category_id=51','test19'),(797,0,1,'category_id=52','test20'),(798,0,1,'category_id=58','test25'),(799,0,1,'category_id=53','test21'),(800,0,1,'category_id=54','test22'),(801,0,1,'category_id=55','test23'),(802,0,1,'category_id=56','test24'),(803,0,1,'category_id=38','test4'),(804,0,1,'category_id=37','test5'),(805,0,1,'category_id=39','test6'),(806,0,1,'category_id=40','test7'),(807,0,1,'category_id=41','test8'),(808,0,1,'category_id=42','test9'),(809,0,1,'product_id=30','canon-eos-5d'),(811,0,1,'product_id=28','htc-touch-hd'),(812,0,1,'product_id=43','macbook'),(813,0,1,'product_id=44','macbook-air'),(814,0,1,'product_id=45','macbook-pro'),(816,0,1,'product_id=31','nikon-d300'),(817,0,1,'product_id=29','palm-treo-pro'),(818,0,1,'product_id=35','product-8'),(819,0,1,'product_id=49','samsung-galaxy-tab-10-1'),(820,0,1,'product_id=33','samsung-syncmaster-941bw'),(821,0,1,'product_id=46','sony-vaio'),(823,0,1,'product_id=40','iphone'),(824,0,1,'product_id=48','ipod-classic'),(825,0,1,'product_id=36','ipod-nano'),(826,0,1,'product_id=34','ipod-shuffle'),(827,0,1,'product_id=32','ipod-touch'),(828,0,1,'manufacturer_id=9','canon'),(829,0,1,'manufacturer_id=5','htc'),(830,0,1,'manufacturer_id=7','hewlett-packard'),(831,0,1,'manufacturer_id=6','palm'),(832,0,1,'manufacturer_id=10','sony'),(834,0,1,'category_id=26','pc'),(835,0,1,'category_id=27','mac'),(836,0,1,'category_id=20','desktops'),(837,0,1,'product_id=41','imac'),(840,0,1,'product_id=47','hp-lp3065'),(841,0,1,'information_id=6','delivery'),(842,0,1,'information_id=3','privacy'),(843,0,1,'information_id=5','terms'),(844,0,1,'category_id=33','camera'),(845,0,1,'category_id=28','monitor'),(847,0,1,'product_id=42','test'),(848,1,1,'product_id=42','test');
...
insert  into `sg_tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values (9,'Taxable Goods','Taxed goods','2009-01-06 23:21:53','2011-09-23 14:07:50');
...
insert  into `sg_tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values (86,3,'VAT (10%)','10.0000','P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)','2.0000','F','2011-09-21 21:49:23','2011-09-23 00:40:19');
...
insert  into `sg_tax_rule`(`tax_rule_id`,`tax_class_id`,`tax_rate_id`,`based`,`priority`) values (120,10,87,'store',0),(121,10,86,'payment',1),(127,9,87,'shipping',2),(128,9,86,'shipping',1);
...
insert  into `sg_test`(`id`,`name`) values (1,NULL),(2,NULL);
...
CREATE TABLE `sg_transaction_rules` (
  `account_transaction_rule_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`account_transaction_rule_id`),
...
insert  into `sg_users`(`id`,`name`,`email`,`password`,`remember_token`,`created_at`,`updated_at`) values (1,'admin','admin@admin.com','$2y$10$flAZmP7ClUp0gG54aYNzNutHgSlMSLyACRg.NVtRpqDfjLouJICIy','Zl8YPO2yZ7xsDMV3JQN26zvfYBth5qQ0qFwMip7kgIdBo0gI4m5KepXYmJ4D',NULL,NULL);
